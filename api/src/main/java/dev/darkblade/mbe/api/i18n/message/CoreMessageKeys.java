...
public enum CoreMessageKeys implements MessageKey {
    ...
    COMMAND_UNKNOWN_SUBCOMMAND("commands.error.unknown_subcommand"),
    ...
    WRENCH_ASSEMBLED("core.wrench.assembled"),
    WRENCH_DISASSEMBLED("core.wrench.disassembled"),
    WRENCH_NOT_FOUND("core.wrench.not_found"),
    WRENCH_INSPECT_TITLE("core.wrench.inspect.title"),
    WRENCH_INSPECT_TYPE("core.wrench.inspect.type"),
    WRENCH_INSPECT_STATE("core.wrench.inspect.state"),
    WRENCH_INSPECT_FACING("core.wrench.inspect.facing"),
    WRENCH_INSPECT_ANCHOR("core.wrench.inspect.anchor"),
    WRENCH_INSPECT_COMPONENT_LINE("core.wrench.inspect.component_line"),
    TOOL_MODE_SWITCHED("core.tool.mode_switched"),
