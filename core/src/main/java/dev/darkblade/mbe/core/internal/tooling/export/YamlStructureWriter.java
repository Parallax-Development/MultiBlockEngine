...
import dev.darkblade.mbe.api.command.ExportBlockPos;
import dev.darkblade.mbe.api.command.ExportBlockSnapshot;
...
final class YamlStructureWriter {
    ...
    private static String writePorts(ExportBlockPos controller, DefaultExportContext ctx) {
        ...
        for (Map.Entry<dev.darkblade.mbe.api.command.ExportBlockPos, String> e : ctx.roles().entrySet()) {
    ...
    private static String writeExtensions(ExportBlockPos controller, DefaultExportContext ctx) {
        ...
        Map<dev.darkblade.mbe.api.command.ExportBlockPos, Map<String, Object>> props = ctx.properties();
        List<Map.Entry<dev.darkblade.mbe.api.command.ExportBlockPos, Map<String, Object>>> propEntries = new ArrayList<>();
        for (Map.Entry<dev.darkblade.mbe.api.command.ExportBlockPos, Map<String, Object>> e : props.entrySet()) {
        ...
        propEntries.sort(Comparator
                .comparingInt((Map.Entry<dev.darkblade.mbe.api.command.ExportBlockPos, Map<String, Object>> e) -> e.getKey().y())
        ...
        if (hasProps) {
            ...
            for (Map.Entry<dev.darkblade.mbe.api.command.ExportBlockPos, Map<String, Object>> e : propEntries) {
                int dx = e.getKey().x() - controller.x();
                int dy = e.getKey().y() - controller.y();
                int dz = e.getKey().z() - controller.z();
