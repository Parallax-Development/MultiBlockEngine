...
public final class ServiceCallParser {
    ...
    public ParseResult parseServicesCall(String[] args) {
        ...
        if (serviceId == null || serviceId.isBlank()) {
            return new ParseResult.Error("Servicio vacío.", List.of("Ejemplo: /mbe services call items info"));
        }
        ...
        if (modeOpt.isEmpty()) {
            return new ParseResult.Error(
                    ...
                    List.of("Valores válidos: info | execute", "Ejemplo: /mbe services call items execute list")
            );
        }
