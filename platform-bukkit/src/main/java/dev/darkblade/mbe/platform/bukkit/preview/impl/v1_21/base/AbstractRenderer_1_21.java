...
public abstract class AbstractRenderer_1_21 extends AbstractProtocolLibRenderer {
    protected AbstractRenderer_1_21(ProtocolLibAdapter adapter) {
    ...
    protected void sendSpawn(Player player, PacketContainer spawnPacket, DisplaySpawnRequest request) {
        ...
        List<WrappedDataValue> values = List.of(
            ...
            new WrappedDataValue(8, WrappedDataWatcher.Registry.get(Integer.class), transform.interpolationDuration()),
            new WrappedDataValue(9, WrappedDataWatcher.Registry.get(Integer.class), transform.startInterpolation())
        );
