# Visual Packet Service

## Purpose
TBD: Provee una interfaz inyectable para que los addons despachen paquetes al cliente a través de PacketEvents de manera segura y abstracta.
